...
function defProp(obj, prop, val) {
  const desc = defProp.desc || (defProp.desc = {
    enumerable: false,
    writable: false,
    configurable: false,
    value: null
...
function arrToString(arr) {
  ...
  let str = `(${(0, _lodash2.default)(arr[0])}`;
...
function makeConstructor(fields, proto) {
  return Object.defineProperty((...args) => makeValue(fields, proto, args, args.length), 'length', { value: fields.length });
}